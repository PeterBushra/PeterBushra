...
<a href="https://github.com/PeterBushra"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=2800&pause=900&color=00FF9C&center=true&vCenter=true&width=850&lines=Senior+Software+Engineer;Architecture+%7C+Performance+Engineering;C%23+%7C+.NET+%7C+C%2B%2B+%7C+WPF+%7C+MFC;Computer+Vision+%7C+AI%2FML+%7C+OpenCV;ASP.NET+%7C+Angular+%7C+React+%7C+Distributed+Systems;Azure+%7C+Docker+%7C+RabbitMQ+%7C+SQL+Server;OutSystems+%7C+Enterprise+Integration" alt="Typing animation" /></a>

<br />

<img src="https://komarev.com/ghpvc/?username=PeterBushra&style=flat-square&color=00ff9c&label=PROFILE+VIEWS" alt="Profile views" />
...
```mermaid
graph TD
    U[USER / BUSINESS WORKFLOW] --> UX[EXPERIENCE LAYER]
    UX --> UI[WPF / WinForms / MFC]
    UX --> WEB[Angular / React / Razor]

    UI --> APP[APPLICATION / DOMAIN]
    WEB --> APP

    APP --> API[ASP.NET / REST / gRPC]
    APP --> CV[COMPUTER VISION / AI]
    APP --> LOW[OUTSYSTEMS]

    API --> MSG[RabbitMQ / MSMQ]
    API --> DATA[SQL Server / EF / Dapper]
    CV --> DATA
    LOW --> API

    MSG --> WORK[WORKERS / SERVICES]
    WORK --> DATA

    API --> INFRA[Docker / IIS / Azure / CI-CD]
    WORK --> INFRA
    DATA --> INFRA
```
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=cs,dotnet,cpp,python,js,ts,angular,react,nodejs,docker,git,github,azure,mongodb,rabbitmq&perline=8" alt="Technology stack" />
</p>
...
```mermaid
graph LR
    A[VB6 / MFC / .NET Framework] --> B[Refactor & Isolate]
    B --> C[Modern .NET / WPF]
    C --> D[Services / APIs]
    D --> E[Distributed Architecture]
    E --> F[Docker / Azure / CI-CD]
```
...
<img src="https://github-readme-stats.vercel.app/api?username=PeterBushra&show_icons=true&include_all_commits=true&count_private=true&hide_border=true&bg_color=0D1117&title_color=00FF9C&text_color=C9D1D9&icon_color=00FF9C" height="180" alt="GitHub statistics" />
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=PeterBushra&layout=compact&hide_border=true&bg_color=0D1117&title_color=00FF9C&text_color=C9D1D9" height="180" alt="Top languages" />
